...
public class D3Url {
	...
	public static String playerProfile2Url(String battlehost, String battletag) {
		try {
			return "http://"+battlehost+"/api/d3/profile/"+URLEncoder.encode(battletag, "UTF-8")+"/";
...
//	}
	...
	public static String hero2Url(String battlehost, String battletag, String heroid) {
		try {
			return playerProfile2Url(battlehost, battletag)+"hero/"+URLEncoder.encode(heroid, "UTF-8");
		} catch (UnsupportedEncodingException e) {
